...
for deg in $(seq 0 4); do
    for sz in 2 4 8 16 32; do
        ./diffusion -k $deg ../../../diskpp/meshes/2D_quads/diskpp/testmesh-$sz-$sz.quad
        mv matrix.txt ../../../diskpp/misc/solvercost/data/matrix-2D-k$deg-$sz-$sz.txt
        mv rhs.txt ../../../diskpp/misc/solvercost/data/rhs-2D-k$deg-$sz-$sz.txt
    done
done
